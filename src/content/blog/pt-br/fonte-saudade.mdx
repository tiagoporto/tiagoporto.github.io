...
> “Em um mundo repleto de mensagens que ninguém pedir para receber, a tipografia precisa frequentemente chamar a atenção para si própria antes de ser lida. Para que ela seja lida, precisa contudo abdicar da mesma atenção que despertou. A tipografia que tem algo a dizer aspira, portanto, a ser uma espécie de estátua transparente. Outra de suas metas tradicionais é a durabilidade – não uma imunidade à mudança, mas uma clara superioridade em relação à moda”. (BRINGHURST, 2005, p.23)
...
### 2.1. Porque produzir tipografia?
...
Durante o processo, surgiu o nome para a tipografia que reúne conteúdo o conceito básico pretendido com a tipografia: uma única palavra para designar todas as mudanças de um sentimento, quase exclusivo do vocabulário da língua portuguesa e que se relaciona às línguas românicas e carrega em seu sentido um mito de ser intraduzível.
...
- ROCHA, Claudio. Projeto Tipográfico, Análise e produção de fontes digitais, 3ª ed., Coleção textos design
  Rosari, São Paulo, 2005
